...
describe('post/ Create a new article ', () => {
  ...
  it('It should not allow admin to create an article(401) ', (done) => {
    const user = {
      id: 1,
      firstName: 'Brown',
      lastName: 'chris',
...
describe('patch/ Edit article', () => {
  ...
  it('it should return only user author allowed to edit this article when admin try(401) ', (done) => {
    const user = {
      id: 1,
      firstName: 'Brown',
      lastName: 'chris',
...
describe('Get/ all articles', () => {
  ...
  it('it should return only users allowed to view the articles when admin try(401) ', (done) => {
    const user = {
      id: 1,
      firstName: 'Brown',
      lastName: 'chris',
...
describe('Get/Display an article ', () => {
  ...
  it('It should return only users allowed when admin try it(401)  ', (done) => {
    const user = {
      id: 1,
      firstName: 'Brown',
      lastName: 'chris',
...
describe('Get/ filter an article by category', () => {
  it('It should return only users allowed when admin try(401)  ', (done) => {
    const user = {
      id: 1,
      firstName: 'Brown',
      lastName: 'chris',
...
describe('Delete/ user delete it own article ', () => {
  it('It should not allow admin to delete an article that are not flagged(401) ', (done) => {
    const user = {
      id: 1,
      firstName: 'Brown',
      lastName: 'chris',
  ...
  it('It should not delete an article that belong to another user(401)  ', (done) => {
    const user = {
      id: 2,
      firstName: 'chris',
      lastName: 'martin',
